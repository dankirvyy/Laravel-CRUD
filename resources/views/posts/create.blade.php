...
<body class="bg-gray-900 text-gray-200">
    <div class="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12 text-center">
            ...
            <p class="text-gray-500 mt-2">Create a new entry in the post database.</p>
        </div>
        ...
        <div class="glass-form rounded-3xl p-8 transform hover:-translate-y-2 transition-all duration-300">
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                    ...
                    <button type="submit"
                            class="w-full sm:w-auto px-6 py-3 btn-neon-green rounded-full shadow-lg font-semibold transform hover:scale-105">
                        <span class="flex items-center justify-center space-x-2">
